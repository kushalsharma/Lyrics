...
public abstract class TypeCreator {
    public abstract TypeSpecBuilder process(HandlerSet handlerSet, TypeModel typeModel);

    protected void handleAdditionalProperties(Tune tune, TypeSpecBuilder typeBuilder, TypeModel typeModel) {
