 ...
 */
public class JavaEnumWithFieldsCreator extends TypeCreator {

    @Override
    public TypeSpecBuilder process(HandlerSet handlerSet, TypeModel typeModel) {
        TypeSpecBuilder typeBuilder = new JavaTypeSpecBuilder(TypeSpec.enumBuilder(handlerSet.getMetaInfo().getClassName()));
