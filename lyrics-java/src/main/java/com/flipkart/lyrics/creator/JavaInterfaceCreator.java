 ...
 */
public class JavaInterfaceCreator extends TypeCreator {

    @Override
    public TypeSpecBuilder process(HandlerSet handlerSet, TypeModel typeModel) {
        TypeSpecBuilder typeBuilder = new JavaTypeSpecBuilder(TypeSpec.interfaceBuilder(handlerSet.getMetaInfo().getClassName()));
