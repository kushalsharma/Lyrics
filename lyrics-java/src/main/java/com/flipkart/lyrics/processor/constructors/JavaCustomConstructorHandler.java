 ...
 */
public class JavaCustomConstructorHandler extends JavaConstructorHandler {

    public JavaCustomConstructorHandler(Tune tune, MetaInfo metaInfo, RuleSet ruleSet) {
