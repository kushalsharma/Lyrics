 ...
 */
public class JavaNoArgsConstructorHandler extends Handler {

    public JavaNoArgsConstructorHandler(Tune tune, MetaInfo metaInfo, RuleSet ruleSet) {
        super(tune, metaInfo, ruleSet);
    }

    @Override
    public void process(TypeSpecBuilder typeSpec, TypeModel typeModel) {
        MethodSpecBuilder constructor = new JavaMethodSpecBuilder(MethodSpec.constructorBuilder()
