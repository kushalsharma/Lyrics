...
import static com.flipkart.lyrics.utils.Helper.getRequiredFields;

/**
 * Created by shrey.garg on 01/02/17.
 */
public class JavaRequiredFieldsConstructorHandler extends JavaConstructorHandler {

    public JavaRequiredFieldsConstructorHandler(Tune tune, MetaInfo metaInfo, RuleSet ruleSet) {
