...
import static com.flipkart.lyrics.utils.Helper.isNullOrEmpty;

/**
 * Created by shrey.garg on 26/11/16.
 */
public class JavaNamedAsRule extends FieldRule {

    public JavaNamedAsRule(Tune tune, MetaInfo metaInfo) {
        super(tune, metaInfo);
    }

    @Override
    public void process(FieldSpecBuilder fieldSpec, FieldModel fieldModel) {
