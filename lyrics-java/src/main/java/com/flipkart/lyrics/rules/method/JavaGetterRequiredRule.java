 ...
 */
public class JavaGetterRequiredRule extends MethodRule {

    public JavaGetterRequiredRule(Tune tune, MetaInfo metaInfo) {
        super(tune, metaInfo);
    }

    public void process(MethodSpecBuilder methodSpec, FieldModel fieldModel, ParameterSpecBuilder parameter) {
