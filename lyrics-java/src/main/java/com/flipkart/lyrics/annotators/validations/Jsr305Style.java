...
import static com.flipkart.lyrics.utils.ClassNames.JSR_305_NON_NULL;
import static com.flipkart.lyrics.utils.ClassNames.JSR_305_NULLABLE;
...
public class Jsr305Style extends ValidationAnnotatorStyle {
    ...
    @Override
    public void processNotRequiredRuleForSetters(MethodSpecBuilder methodSpec, FieldModel fieldModel, ParameterSpecBuilder parameterSpec) {
