 ...
 */
public class JavaDefaultStyle extends ObjectMethodsStyle {

    @Override
    public void processToString(MethodSpecBuilder toStringBuilder, List<String> nonStaticFields, MetaInfo metaInfo) {
    ...
    @Override
    public void processEqualsAndHashCode(MethodSpecBuilder equalsBuilder, MethodSpecBuilder hashCodeBuilder, List<String> nonStaticFields, MetaInfo metaInfo, boolean testSuperEquality) {
